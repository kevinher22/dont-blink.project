...
export const HUD: React.FC<HUDProps> = ({
  ...
  return (
    <div
      id="game-hud"
      className="absolute inset-0 pointer-events-none flex flex-col justify-between p-4 md:p-6 select-none"
    >
      {/* Top Header Bar */}
      <div className="flex items-start justify-between w-full">
        ...
        <div className="flex items-center gap-2">
          {/* Distance Indicator */}
          <div className="flex items-center gap-1.5 bg-slate-900/70 backdrop-blur-md px-3 py-1.5 rounded-xl border border-slate-700/50 text-cyan-300">
          ...
          {/* Best Score */}
          <div className="hidden sm:flex flex-col items-center bg-slate-900/60 backdrop-blur-md px-4 py-1 rounded-xl border border-slate-700/50">
            <div className="text-[9px] font-bold tracking-wider text-slate-400 uppercase">
              {i18n.t('bestScore')}
            </div>
            <div className="text-sm font-bold text-amber-400 font-['Chakra_Petch']">
        ...
        <div className="flex items-center gap-2 pointer-events-auto">
          ...
          <button
            ...
            className="p-2 rounded-xl bg-slate-900/70 backdrop-blur-md border border-slate-700/60 text-slate-300 hover:text-white hover:border-slate-500 transition-colors cursor-pointer"
          ...
          <button
            ...
            className={`p-2 rounded-xl bg-slate-900/70 backdrop-blur-md border border-slate-700/60 transition-colors cursor-pointer ${
          ...
          <button
            ...
            className="p-2 rounded-xl bg-slate-900/80 backdrop-blur-md border border-slate-700/60 text-white hover:bg-slate-800 transition-colors cursor-pointer"

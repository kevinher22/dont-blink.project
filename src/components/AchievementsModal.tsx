...
export const AchievementsModal: React.FC<AchievementsModalProps> = ({
  ...
  return (
    <div id="achievements-modal" className="absolute inset-0 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md z-30 select-none">
      <div className="w-full max-w-md bg-gradient-to-b from-slate-900 via-slate-900/95 to-slate-950 p-6 rounded-3xl border border-slate-800 shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="overflow-y-auto pr-1 my-3 space-y-2.5 max-h-[62vh]">
